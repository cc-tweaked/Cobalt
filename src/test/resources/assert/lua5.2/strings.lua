_noformatA = true -- FIXME: Float formatting is hard!
...
-- assert(not string.find("", "", 2)) TODO: Here for Lua 5.1 compatibility. Worth keeping?
...
-- FIXME: assert(string.format('%q', "\0") == [["\0"]])
...
if not _nolonglong then
  ...
  -- FIXME: assert(x == 0xfffffffffffff800)
  -- FIXME: assert(tonumber(string.format("%u", x)) == x)
  -- FIXME: assert(tonumber(string.format("0X%x", x)) == x)
  -- FIXME: assert(string.format("%x", x) == "fffffffffffff800")
  assert(string.format("%d", x/2) == "9223372036854774784")
  assert(string.format("%d", -x/2) == "-9223372036854774784")
  assert(string.format("%d", -2^63) == "-9223372036854775808")
  -- FIXME: assert(string.format("%x", 2^63) == "8000000000000000")
end
...
-- TODO: Works in Lua 5.1, so not sure what to do here!
...
if not _no32 then
  ...
  assert(table.concat({}, "x", 2^31-1, -2^31) == "")
  -- FIXME: assert(table.concat({[2^31-1] = "alo"}, "x", 2^31-1, 2^31-1) == "alo")
end
