describe("The base library", function()
	...
	describe("tostring", function()
		...
		describe("numbers", function()
			...
			it("floats roundtrip :lua>=5.5", function()
				expect(tostring(1/3)):eq("0.33333333333333331")
				expect(tonumber(tostring(1/3))):eq(1/3)

				expect(tostring(1.24567890123456789)):eq("1.2456789012345679")
				expect(tostring(1.2456789012345678)):eq("1.2456789012345677")
				expect(tostring(1.245678901234567)):eq("1.245678901234567")
				expect(tostring(1.24567890123456)):eq("1.24567890123456")
				expect(tostring(1.2456789012345)):eq("1.2456789012345")
			end)

			it("large floats :lua<5.5 :!cobalt", function()
				expect(tostring(4611686018427387904.0)):eq("4.6116860184274e+18")
				expect(tostring(-4611686018427387904.0)):eq("-4.6116860184274e+18")
				expect(tostring(9223372036854775807.0)):eq("9.2233720368548e+18")
			end)

			it("large floats :lua>=5.5", function()
				expect(tostring(4611686018427387904.0)):eq("4.6116860184273879e+18")
				expect(tostring(-4611686018427387904.0)):eq("-4.6116860184273879e+18")
				expect(tostring(9223372036854775807.0)):eq("9.2233720368547758e+18")
			end)

			it("large integers :lua<=5.2 :!cobalt", function()
				expect(tostring(4611686018427387904)):eq("4.6116860184274e+18")
				expect(tostring(-4611686018427387904)):eq("-4.6116860184274e+18")
				expect(tostring(9223372036854775807)):eq("9.2233720368548e+18")
			end)

			it("large integers :lua>=5.3 :!cobalt", function()
